...
- **Generated hero geometry and split pricing content crossed shared boundaries (v02.11.99, fixed for v02.11.100):**
  ...
  create a duplicate. Runtime coverage is `217 checks OK`. v02.11.100 was
  installed through WP Pusher and live post 4556 confirmed one generated hero
  root, one pricing composition root, desktop row/mobile column geometry,
  exact hero content and both CTA URLs after read-back.
