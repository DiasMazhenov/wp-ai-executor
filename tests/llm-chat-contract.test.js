...
assert.match(bootstrap, /Version:\s+v02\.10\.96/);
assert.match(bootstrap, /const WPAE_VERSION = 'v02\.10\.96'/);
...
assert.match(llm, /'benefits' => '\/benefit\|feature\|course\|courses\|обуч/);
