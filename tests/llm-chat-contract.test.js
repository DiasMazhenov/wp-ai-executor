...
assert.match(bootstrap, /Version:\s+v02\.11\.17/);
assert.match(bootstrap, /const WPAE_VERSION = 'v02\.11\.17'/);
...
const pricingPriority = llm.indexOf("return 'pricing';", llm.indexOf("function wpae_llm_detect_block_archetype"));
assert.ok(pricingPriority >= 0 && pricingPriority < teamPriority);
