...
assert.match(bootstrap, /Version:\s+v02\.11\.15/);
assert.match(bootstrap, /const WPAE_VERSION = 'v02\.11\.15'/);
...
assert.match(js, /AI Vision недоступен\. Новая генерация отменена/);
