...
assert.match(bootstrap, /Version:\s+v02\.10\.81/);
assert.match(bootstrap, /const WPAE_VERSION = 'v02\.10\.81'/);
...
assert.match(js, /refreshElementorPreview\(\)\.catch\(function \(\) \{ return false; \}\)\.then/);
