...
assert.match(bootstrap, /Version:\s+v02\.11\.11/);
assert.match(bootstrap, /const WPAE_VERSION = 'v02\.11\.11'/);
...
assert.match(llm, /\$content_shell\['settings'\]\[ \$padding_key \]\['top'\] = '0'/);
