...
assert.match(bootstrap, /Version:\s+v02\.10\.80/);
assert.match(bootstrap, /const WPAE_VERSION = 'v02\.10\.80'/);
...
assert.match(llm, /function wpae_llm_normalize_hero_composition/);
