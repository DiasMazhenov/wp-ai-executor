...
$check( ! array_key_exists( 'background_color', $team_group['settings'] ?? [] ) && ( $team_cards[1]['settings']['background_color'] ?? '' ) === '#ffffff' && ( $team_cards[1]['settings']['flex_gap']['size'] ?? 0 ) === 0.5, 'team wrapper stays transparent, card surface remains, and content uses a compact native Flex gap' );
...
$check( ! array_key_exists( 'background_color', $testimonial_group['settings'] ?? [] ) && ( $testimonial_cards[0]['settings']['background_color'] ?? '' ) === '#ffffff', 'testimonial card group is transparent and the card retains its white surface' );
