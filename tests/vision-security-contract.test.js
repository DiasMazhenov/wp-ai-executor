...
assert.match(vision, /capture_complete/);
assert.match(vision, /target_scroll_height/);
assert.match(vision, /The screenshot capture is incomplete relative to the measured target bounds/);
