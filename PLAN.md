...
1. Add `/elementor/recipes` with native Elementor section patterns.
...
2. Expand agent conformance scoring into design quality gates.
...
3. Add `/elementor/blueprint` for page planning before writing.
...
4. Add project design tokens in the dashboard and `/guide`.
...
5. Add stronger preflight checks before Elementor writes.
...
6. Add after-save quality summary.
...
7. Consider a future `/visual-audit` endpoint.
...
8. Optionally add preset buttons for existing single-key capability toggles.
