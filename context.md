...
Release state: local `v02.09.46` prepared, including the LLM proxy, Elementor editor chat,
...
The latest local release `v02.09.46` is prepared for publication on GitHub `main`. On
