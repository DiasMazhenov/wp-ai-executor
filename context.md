...
Release state: `v02.08.92` including the LLM proxy, Elementor editor chat,
...
diagnostics, the masked AI Vision key field, and chat model/version metadata are published on GitHub `main` in commit `b4ca5c5`.
