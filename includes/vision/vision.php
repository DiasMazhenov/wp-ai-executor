...
function wpae_vision_prompt( WP_REST_Request $request ): string {
    ...
    $generated_json = $request->get_param( 'generated_json' );
    $generated_json_text = is_string( $generated_json ) ? wpae_vision_trim_text( $generated_json, 3500 ) : ( is_array( $generated_json ) ? wpae_vision_trim_text( wp_json_encode( $generated_json, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES ), 3500 ) : '' );
    ...
    return "Review this WordPress/Elementor page screenshot as a senior UI/UX and accessibility reviewer. Viewport: {$viewport}.\n"
        ...
        . ( $generated_json_text !== '' ? "Generated Elementor JSON excerpt: {$generated_json_text}\n" : '' )
