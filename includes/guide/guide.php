        ...
        'runtime_elementor_validation' => [
            ...
            'block_library_policy' => [
                ...
                'instantiate_modes' => [
                    ...
                    'adapt' => 'Run compatibility mode and apply current design-system marker classes. This version does not promise full color/typography token remapping.',
                ],
                'agent_workflow' => [
...
Elementor block library note: before generating a common section from scratch, search GET /elementor/blocks. The library accepts raw native Elementor JSON and wpae-elementor-block-v1 wrappers, including foreign blocks with no design_system_id. Use preserve to keep the original design, compatibility to normalize for current Flexbox structured writes, or adapt to add the current design-system markers and safe baseline settings. Never silently restyle a foreign block. Always inspect compatibility, missing widgets/media, protected enhancement zones, structured_write_ready, and validation errors before merging the returned elementor_data into a page.
