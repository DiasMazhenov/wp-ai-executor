...
function wpae_agent_guide(): array {
    return [
        ...
        'workflow' => [
            ...
            '4m. For horizontal process/timeline cards only, use the supplied reference card as the visual contract: white native card, 1px #dbe3f0 border, 20px radius, 1rem .75rem 1.25rem padding, 22% desktop width and 100% mobile width. Keep the horizontal marker rail and connectors outside card surfaces; every connector must be a native Elementor Divider widget, never an HTML widget or CSS-only line. Do not change the existing vertical timeline card settings.',
