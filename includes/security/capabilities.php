    ...
    return [
        ...
        'elementor' => [
            ...
            'safe_endpoints' => [
                ...
                'design_system_update' => 'POST /wp-json/ai-executor/v1/elementor/design-system/update',
                ...
                'templates' => 'GET /wp-json/ai-executor/v1/elementor/templates',
                'template' => 'GET /wp-json/ai-executor/v1/elementor/templates/{id}',
            ...
            'native_style_policy' => [
                ...
                'css_to_native_map' => [
                    ...
                    'flex_grid' => [
                        'display:flex' => 'flex_direction, flex_justify_content, flex_align_items',
                        'gap' => 'flex_gap',
                        'flex-wrap' => 'flex_wrap',
                    ],
                ],
